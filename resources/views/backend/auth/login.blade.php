...
<!-- Mirrored from uselooper.com/auth-signin-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 17:51:24 GMT -->
    {{-- @dd('234') --}}
...
<body>
    ...
    <main class="auth auth-floated">
        ...
        <form action="{{route('admin.login.submit')}}" method="POST" class="auth-form">
            ...
            <div class="mb-4">
                <div class="mb-3">
                    <img class="rounded" src="{{asset('front/assets/img/'.$logo->logo??'admin/assets/apple-touch-icon.png')}}" alt="" height="72">
                </div>
            ...
            <!-- copyright -->
            <p class="mb-0 px-3 text-muted text-center"> &copy; {{date('Y');}} All Rights Reserved. Loper is Responsive Admin Theme
